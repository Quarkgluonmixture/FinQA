...
# Continuous execution loop for FinQA verification matrix.
#
# Start:
#   nohup bash run_verification_matrix_loop.sh > logs/run_verification_matrix_loop.console.log 2>&1 &
#   echo $! > logs/run_verification_matrix_loop.pid
#
# Stop:
#   kill "$(cat logs/run_verification_matrix_loop.pid)"
...
LOOP_LOG="${LOOP_LOG:-${LOG_DIR}/run_verification_matrix_loop.log}"
